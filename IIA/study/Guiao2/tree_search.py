...
class SearchTree:
    ...
    def avg_branching(self):
        return round((self.non_terminals + self.terminals -1)/(self.non_terminals),2)
    ...
    def search(self, limit = None):
        while self.open_nodes != []:
            ...
            for a in self.problem.domain.actions(node.state):
                ...
                newnode = SearchNode(newstate,node, node.depth+1, self.problem.domain.cost(node.cost, a) + node.cost, self.problem.domain.heuristic(newstate, self.problem.goal))
